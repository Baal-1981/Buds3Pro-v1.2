...
namespace Buds3ProAideAuditiveIA.v2
{
    ...
    public class AudioForegroundService : Service
    {
        ...
        public override StartCommandResult OnStartCommand(Intent intent, StartCommandFlags flags, int startId)
        {
            ...
            {
                // Actions: OPEN (ramener l'app), QUIT (terminer)
                var openIntent = new Intent(this, typeof(MainActivity));
                openIntent.AddFlags(ActivityFlags.NewTask | ActivityFlags.SingleTop | ActivityFlags.ClearTop);
                var piOpen = PendingIntent.GetActivity(this, 1001, openIntent, PendingIntentFlags.Immutable | PendingIntentFlags.UpdateCurrent);

                var quitIntent = new Intent(this, typeof(AppControlReceiver)).SetAction(AppControlReceiver.ACTION_EXIT);
                var piQuit = PendingIntent.GetBroadcast(this, 1002, quitIntent, PendingIntentFlags.Immutable | PendingIntentFlags.UpdateCurrent);
                ...
                var notif = new NotificationCompat.Builder(this, CHANNEL_ID)
                    ...
                    .AddAction(0, "Ouvrir", piOpen)
                    .AddAction(0, "Quitter", piQuit)
                    .SetOngoing(true)
