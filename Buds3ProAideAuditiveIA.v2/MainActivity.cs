...
namespace Buds3ProAideAuditiveIA.v2
{
    ...
    public class MainActivity : AppCompatActivity, ILogSink
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            // ===== Events =====
            _btnStart.Click += (s, e) => StartAudioIfNeeded(startRequestedByUser: true);
            _btnStop.Click += (s, e) => { _engine.Stop(); SetStatus("STOP ◼"); };
        ...
        private LinearLayout BuildRoutePanel()
        {
            ...
            _rbA2dp = new RadioButton(this) { Text = "A2DP / Media (Music stream)", Checked = true };
            _rbSco = new RadioButton(this) { Text = "SCO / HFP (Voice call stream)" };
            _rbLc3Auto = new RadioButton(this) { Text = "LE Audio (LC3) — auto (system decides)", Checked = false };
        ...
        private LinearLayout BuildQualityPanel()
        {
            ...
            var rb50 = new RadioButton(this) { Text = "50 Hz", Checked = true };
            var rb60 = new RadioButton(this) { Text = "60 Hz" };
        ...
        private void StartAudioIfNeeded(bool startRequestedByUser)
        {
            ...
            try { _latency.Text = $"Latency: {_engine.TransportLatencyMs} ms"; } catch { }
            UpdateRouteLabel();
        }
        ...
        private void UpdateRouteLabel()
        {
            ...
            catch { _routeInfo.Text = "Sortie: (unknown)"; }
        }
